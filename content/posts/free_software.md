...
- *All-purpose*: One can learn how to use a free program, become good at it, and then use it, years later, in scenarios that hadn't been anticipated (such as an unexpected commercial endeavor from what looked like would have remained just a hobby), thanks to the unrestricted freedom to run it.
