...
The 1st of January is Public Domain Day: the day in which a new batch of works enters the public domain and becomes free for all to build upon.
...
Disney itself built [massively](https://www.forbes.com/sites/derekkhanna/2014/02/03/50-disney-movies-based-on-the-public-domain/) on the public domain, including with films like *Robin Hood*, *Peter Pan*, *Tarzan* and *Cinderella*. This didn't stop it fom working hard to deprive it trough its lobbying efforts.
...
- [Openverse](https://openverse.org/): Search engine for images and audios under free licenses, many of which (those tagged with either the [Public Domain Mark](https://creativecommons.org/publicdomain/mark/1.0/) or CC0).
- [Smithsonian Open Access](https://www.si.edu/openaccess): Large collections of works in the public domain. Images and data are dedicated to the public domain trough CC0.
...
- [Poly Haven](https://polyhaven.com/): Assets for 3D artists dedicated to the public domain trough CC0.
